...
sec_contact_model.set_params({'tdiv_sc': 822442.4352504411, 'ne_s': 206231.63887060722, 'ne_c': 527132.489412328, 'mig_secc': 0.006024102906454381, 'tmig_secc': 24999.670046719617})
...
sec_contact_model_copy = sec_contact_model.copy()
...
for i in range(n_bootstraps):
	...
	sec_contact_model_copy.set_data(resampled_sfs)
	#add_pulse_copy.set_data(resampled_sfs)

	# choose new random parameters for submodel, optimize
	sec_contact_model_copy.set_params(randomize=True)
	sec_contact_model_copy.optimize()
	...
	bootstrap_results.append(sec_contact_model_copy.get_params())

## Save bootstrappies
with open("cardinalis-bootstrap-results-secc.txt", 'w') as outfile:
