...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_priorset_5_stoch_asym.txt")
...
print("DIV TIME RANGE: 1,000,000 to 1,500,000")
divtimelow=1000000
divtimehigh=1500000
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_checkpoint_priorset5_stoch_asym.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
