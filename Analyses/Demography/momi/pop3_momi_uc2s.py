...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_pop3_uc2s.txt")
...
uni_chi_to_son_model.add_pulse_param("mig_c2s",lower=0,upper=0.5)
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_3pop_checkpoint_uc2s.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
