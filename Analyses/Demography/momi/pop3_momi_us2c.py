...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_pop3_us2c.txt")
...
uni_son_to_chi_model.add_pulse_param("mig_s2c",lower=0,upper=0.5)
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_3pop_checkpoint_us2c.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
