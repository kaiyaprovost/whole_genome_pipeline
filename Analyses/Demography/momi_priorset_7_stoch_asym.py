...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_priorset_7_stoch_asym.txt")
...
print("NE RANGE: 100,000 to 500,000")
nelow=100000
nehigh=500000
...
print("MIGRATION DATE RANGE: 250,000 to 500,000\n\n")
migtimelow=250000
migtimehigh=500000
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_checkpoint_priorset7_stoch_asym.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
