...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_pop3_symm.txt")
...
## add parameters
symm_model.add_pulse_param("mig_symm",lower=0,upper=0.5)
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_3pop_checkpoint_symm.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
