# Rscript /Users/kprovost/Documents/Dissertation/CHAPTER2_GENOMES/ANALYSIS/DXY/plotDXY.R

specieslist = c("bel","bil","bru",
                "cri","cur","fla",
                "fus","mel","sin"
                ,"nit"
                )
...
for (spp in specieslist) {
  ...
  sonfile = paste("/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/DXY/",spp,"_SON_Dxy_persite.txt",sep="")
  outfile = paste("/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/DXY/",spp,"_SON_Dxy_WINDOWS_",num_to_keep,".txt",sep="")
  pngfile = paste("/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/DXY/",spp,"_SON_DxyMEAN_WINDOWS_",num_to_keep,".png",sep="")
  sumfile = paste("/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/DXY/",spp,"_SON_DxySUMS_WINDOWS_",num_to_keep,".png",sep="")
  sdvfile = paste("/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/DXY/",spp,"_SON_DxySDVS_WINDOWS_",num_to_keep,".png",sep="")
