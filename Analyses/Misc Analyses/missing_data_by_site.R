filelist = list.files(
  #path="/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER2_GENOMES/ANALYSIS/called_geno/MISSING",
  path="/Users/kprovost/Dropbox (AMNH)/Dissertation/CHAPTER2_GENOMES/",
  pattern="lmiss.lmiss$",
...
for(file in filelist){
  ...
  if(!(file.exists(paste(file,".windows.txt",sep="")))) {
    ...
    offset = 10000
    #windows = c()
    for (chrom in unique(onlychrom$CHR)) {
      first = T
      print(chrom)
