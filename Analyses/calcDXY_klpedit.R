...
opt = data.frame("popA"="/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/Toxostoma-crissale-CHIDXY.mafs",
                  "popB"="/vz-nas1-active/ProcessedGenomicReads/EVERY_PLATE/ANGSD/Toxostoma-crissale-SONDXY.mafs",
                  "totLen"=1000000000,
                 stringsAsFactors = F)
...
print("calculating DXY (original way)")
## knownEM is the allele frequencies 
