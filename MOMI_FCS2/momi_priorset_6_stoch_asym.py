...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_priorset_6_stoch_asym.txt")
...
print("MIGRATION RANGE: 0.2 to 0.3")
migratelow=0.2
migratehigh=0.3
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5, save_to_checkpoint="momi_checkpoint_priorset6_stoch_asym.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
