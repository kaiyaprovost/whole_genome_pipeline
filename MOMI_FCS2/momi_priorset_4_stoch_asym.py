...
logging.basicConfig(level=logging.INFO,
                    filename="momi_log_priorset_4_stoch_asym.txt")
...
for model in models:
    ...
    model.stochastic_optimize(num_iters=10, n_minibatches=5,save_to_checkpoint="momi_checkpoint_priorset4_stoch_asym.txt", svrg_epoch=-1)
    now = datetime.datetime.now()
